...
bool           b_is_hold = false;
        ...
        const   char                    *VSH_NAMES_SD                           [VSH_SD]                    = { "preset00.vsh" }; 
        const   char                    *VSH_NAMES_USB                          [VSH_USB]                   = {};
        const   char                    *FSH_NAMES_SD                           [FSH_SD]                    = { "preset00.fsh", "preset01.fsh"  };
        const   char                    *FSH_NAMES_USB                          [FSH_USB]                   = { "user00.fsh",   "user01.fsh",  "user02.fsh",   "user03.fsh", "user04.fsh",   "user05.fsh",  "user06.fsh",   "user07.fsh",
                                                                                                                "user08.fsh",   "user09.fsh",  "user10.fsh",   "user11.fsh", "user12.fsh",   "user13.fsh",  "user14.fsh",   "user15.fsh",
                                                                                                                "user16.fsh",   "user17.fsh",  "user18.fsh",   "user19.fsh", "user20.fsh",   "user21.fsh",  "user22.fsh",   "user23.fsh",
                                                                                                                "user24.fsh",   "user25.fsh",  "user26.fsh",   "user27.fsh", "user28.fsh",   "user29.fsh",  "user30.fsh",   "user31.fsh"    };
        const   char                    *TEX_NAMES_SD                           [TEX_SD]                    = { "preset00.bmp", "preset01.bmp"  };
        const   char                    *TEX_NAMES_USB                          [TEX_USB]                   = { "user00.bmp",   "user01.bmp",  "user02.bmp",   "user03.bmp", "user04.bmp",   "user05.bmp",  "user06.bmp",   "user07.bmp"    };
//      const   char                    *VID_NAMES_SD                           [VID_SD]                    = { "user00.264",   "user01.264",  "user02.264",   "user03.264", "user04.264",   "user05.264",  "user06.264",   "user07.264"    };
//      const   char                    *VID_NAMES_USB                          [VID_USB]                   = {};
        const   char                    *VID_NAMES_SD                           [VID_SD]                    = {};
        const   char                    *VID_NAMES_USB                          [VID_USB]                   = { "user00.264",   "user01.264",  "user02.264",   "user03.264", "user04.264",   "user05.264",  "user06.264",   "user07.264"    };
